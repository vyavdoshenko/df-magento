...
Docker-based Magento 2.4.8 development environment with Dragonfly (Redis-compatible) for caching and sessions.
...
### Dragonfly connection error
Check if Dragonfly is running and accessible:
```bash
docker exec -it magento_app bash -c "nc -zv dragonfly.service 6379"
```
